...
2. **Recover the closest original.** Prefer participant/original posts over secondary embeds when available.
...
8. **Publish the visual record.** Card summary should be one short natural sentence. Display classification values so they make sense without field labels, e.g. `By settlers`, `Against Palestinians in the West Bank`.
